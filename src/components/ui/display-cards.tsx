...
function DisplayCard({
  ...
  return (
    <div
      className={cn(
        "relative flex h-36 w-[22rem] -skew-y-[8deg] select-none flex-col justify-between overflow-hidden rounded-xl border-2 bg-muted/80 px-4 py-3 backdrop-blur-sm transition-all duration-700 hover:border-white/20 hover:bg-muted [&>*]:flex [&>*]:items-center [&>*]:gap-2",
        className,
      )}
    >
      <div>
